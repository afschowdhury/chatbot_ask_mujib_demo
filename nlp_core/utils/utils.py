...
def change_to_mujib_english(questions):
    mujib_names = ["bangabandhu", "bangabandhu's", "sheikh", "sheikh mujibur rahman",
                   "sheikh mujib",   "father of the nation"]
    changed_question = []
    for question in questions:
        ...
        for name in mujib_names:
            altered_ques = altered_ques.replace(name, "mujib")

        while "mujib mujib" in altered_ques:
            altered_ques = altered_ques.replace("mujib mujib", "mujib")
        changed_question.append(altered_ques)
